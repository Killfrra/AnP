...
Field list_element_fields[] = {
	field( 1,  6,             6, read_string     ,  strcmp, "������"     , group_name      , { allow: ALLOW_DIGITS }),
	...
	field(30, 10,  sizeof(Date), read_fixed_date ,  cmpdte, "��������  " , birth_date      , {0}),
	field(42, 10,  sizeof(Date), read_fixed_date ,  cmpdte, "�����������", admission_date  , {0}),
	field(55,  3, sizeof(short), read_fixed_short,  shrcmp, "���"        , USE_score       , {0}),
    field(60, 32,            32, read_string     ,  strcmp, "���"        , full_name       , { allow: ALLOW_NOTHING })
};
#undef field
